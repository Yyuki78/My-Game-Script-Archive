...
public class CarState : MonoBehaviour
{
    ...
    public bool IsDrive { private set; get; }
    public bool SomeWheelHit { private set; get; } = false;
    public bool isStickWall { private set; get; } = false;
