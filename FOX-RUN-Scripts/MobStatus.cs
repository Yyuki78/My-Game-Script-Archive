...
public abstract class MobStatus : MonoBehaviour
{
    ...
    /// 座れるかどうか
    /// </summary>
    public bool IsSittable => StateEnum.Normal == _state|| StateEnum.Sit == _state;

    /// <summary>
    /// 座っているかどうか
    /// </summary>
    public bool IsSitState => StateEnum.Sit == _state;
    ...
    /// 可能であれば座っている状態に遷移します。
    /// </summary>
    public void GoToSitStateIfPossible()
    {
        if (!IsAttackable) return;

        _state = StateEnum.Sit;
    }
